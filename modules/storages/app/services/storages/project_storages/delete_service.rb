...
module Storages
  module ProjectStorages
    ...
    class DeleteService < ::BaseServices::Delete
      ...
      def auth_strategy
        Adapters::Registry.resolve("#{model.storage}.authentication.userless").call
      end

      def delete_project_folder
        Adapters::Input::DeleteFolder.build(location: model.project_folder_location).bind do |input_data|
          Adapters::Registry.resolve("#{model.storage}.commands.delete_folder")
                            .call(storage: model.storage, auth_strategy:, input_data:)
        end
      end
      ...
      def delete_associated_file_links
        ...
        file_links = FileLink.where(storage_id: model.storage_id,
